...
public class Flow_BiNvl_Test {
    @Test
    public void testHybridFlowBiNvl() throws Exception {
        ...
        Disposable link = a.flow().biNvl(0).sync().force().to(b);
    ...
    @Test
    public void testInOutFlowBiNvl() throws Exception {
        HasValue<Integer> a = Flow.newHasValue();
        HasValue<Integer> b = Flow.newHasValue();
        ...
        Disposable link = a.flow().sync().biNvl(0).force().to(b);
